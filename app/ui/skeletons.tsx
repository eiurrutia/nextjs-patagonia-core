...
export function ProductMasterTableSkeleton() {
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
                ...
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    <div className="mb-2 flex items-center">
                      <div className={`${shimmer} h-4 w-20 rounded-md bg-gray-200`} />
                    </div>
                    <div className={`${shimmer} h-4 w-32 rounded-md bg-gray-200`} />
                  </div>
                  <div className={`${shimmer} h-6 w-16 rounded-full bg-gray-200`} />
                </div>
                <div className="flex w-full items-center justify-between pt-4">
                  <div>
                    <div className={`${shimmer} h-6 w-16 rounded-md bg-gray-200 mb-2`} />
                    <div className={`${shimmer} h-4 w-24 rounded-md bg-gray-200`} />
                  </div>
                  <div className="flex justify-end gap-2">
                    <div className={`${shimmer} h-8 w-8 rounded-md bg-gray-200`} />
                    <div className={`${shimmer} h-8 w-8 rounded-md bg-gray-200`} />
                  </div>
                </div>
              </div>
            ...
            <tbody className="bg-white">
              {Array.from({ length: 6 }, (_, i) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3">
                    <div className={`${shimmer} h-4 w-16 rounded-md bg-gray-200`} />
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
                    <div className={`${shimmer} h-4 w-24 rounded-md bg-gray-200`} />
                  </td>
