...
import { updateProductMaster } from '@/app/lib/trade-in/product-master-actions';
...
export default function EditProductForm({
  ...
  product: TradeInProductMaster;
}) {
  const initialState = { message: null, errors: {} };
  const updateProductWithId = updateProductMaster.bind(null, product.id);
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={product.condition_state}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                type="number"
                step="0.01"
                defaultValue={product.credit_amount}
