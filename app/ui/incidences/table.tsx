          ...
          <table className="hidden min-w-full text-gray-900 md:table">
            ...
            <tbody className="bg-white">
              {incidences?.map((incidence) => (
                ...
                >
                  <td className="whitespace-nowrap font-bold text-blue-900 text-base px-3 py-3">
                  ...
                  <td className="whitespace-wrap py-3 pl-6 pr-3">
                  ...
                  <td className="whitespace-nowrap px-3 py-3">
                    {incidence.INCIDENCE_CREATE_DATE}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
                    {incidence.LAST_REGISTER_DATE}
                  </td>
